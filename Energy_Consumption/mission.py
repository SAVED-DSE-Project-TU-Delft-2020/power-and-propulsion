...
def main(m_tot, m_bat_cell, A_prop, Cl_max, Cd_climb, S, phi, Cl_cruise, LD, Cd0, h_cruise, DoD, EOL_corr, eta_bat):
    '''
    ...
    E_go, t_go, P_go, lab = E_trip(W_incl, A_prop, Cl_max, Cd_climb, S, phi, Cl_cruise, LD, Cd0, h_cruise)
    E_arr, t_arr, P_arr, lab = E_trip(W_excl, A_prop, Cl_max, Cd_climb, S, phi, Cl_cruise, LD, Cd0, h_cruise, t_go, E_go, P_go, lab, trip='back')
